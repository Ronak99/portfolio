...
/**
 * Landscape (16:9) shell that wraps every game. The header (name + shuffle) and
 * footer caption are identical across all three games — only `children` (the
 * body) changes. The body is a flex region the games fill with a square board +
 * a side info column. Keyboard shuffle lives in the parent (GameHost).
 */
